...
| 模式         | 说明                                                                                  | 进度   |
| :----------: | :-----------------------------------------------------------------------------------: | :----: |
| 迭代器模式   | [迭代器模式](code/Iterator/README.md)                                                 | 已完成 |
| 适配器模式   | [类适配器模式](code/Adapter_01/README.md) [对象适配器模式](code/Adapter_02/README.md) | 已完成 |
| 模板方法模式 | [模板方法模式](code/TemplateMethod/README.md)                                         | 已完成 |
